...
function navigate_edit(navigation,name,size_price,id){
  navigation.navigate("Size Edit",{name,size_price,id});
}
...
const renderHiddenItem = (data, rowMap) => (
    <View style={styles.rowBack}>
        ...
        <TouchableOpacity
            ...
            onPress={() =>  navigate_edit(navigation, data.item.name, data.item.size_price, data.item.key)}
        >
